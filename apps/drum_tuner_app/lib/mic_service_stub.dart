...
MicServiceDelegate createMicServiceDelegate(Duration amplitudeInterval) {
  return _NativeMicServiceDelegate(amplitudeInterval);
}

class _NativeMicServiceDelegate implements MicServiceDelegate {
  _NativeMicServiceDelegate(Duration amplitudeInterval)
